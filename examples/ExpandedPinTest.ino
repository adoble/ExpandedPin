...
ExpandedPin vsChipSelect = ExpandedPin(12,13, HIGH, HIGH);
ExpandedPin memChipSelect = ExpandedPin(12,13, HIGH,LOW);
ExpandedPin fpChipSelect = ExpandedPin(12,13, LOW, LOW);
